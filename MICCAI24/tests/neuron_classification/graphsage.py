...
from src.models.GraphEncoder.graphsage import GraphSAGE
...
def main():
    ...
    model = GraphSAGE(input_dim=dataset.num_features, hidden_dim=hidden_dim, out_channels=hidden_dim, node_num=dataset[0].x.shape[0])
    ...
    link_loss = torch.nn.CrossEntropyLoss()
