...
from src.models.GraphEncoder.gcn import GCN
...
def main():
    ...
    model = GCN(input_dim=dataset.num_features, hidden_dim=hidden_dim, out_channels=hidden_dim, node_num=dataset[0].x.shape[0])
